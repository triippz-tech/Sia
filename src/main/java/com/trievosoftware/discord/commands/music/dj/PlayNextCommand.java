...
public class PlayNextCommand extends AbstractDjCommand {

    private String loadingEmoji;

    public PlayNextCommand(Sia sia, String loadingEmoji) {
        super(sia);
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        event.reply(loadingEmoji+" Loading... `["+args+"]`", m
            -> sia.getPlayerManager().loadItemOrdered(event.getGuild(), args, new ResultHandler(m,event,false)));
    }
