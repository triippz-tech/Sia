...
public class PardonCmd extends ModCommand
{
    ...
    protected void execute(CommandEvent event)
    {
        ...
        args.ids.forEach(id -> 
        {
            ...
            int strikes = sia.getDatabase().strikes.getStrikes(event.getGuild(), id);
            if(strikes==0)
            ...
            else
            {
                ...
                sia.getStrikeHandler().pardonStrikes(event.getMember(), event.getMessage().getCreationTime(), id, strikes, args.reason);
