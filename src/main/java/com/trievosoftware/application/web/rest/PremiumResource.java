...
public class PremiumResource {
    ...
    public ResponseEntity<Premium> createPremium(@Valid @RequestBody Premium premium) throws URISyntaxException {
     ...
     */
    @PutMapping("/premiums")
    public ResponseEntity<Premium> updatePremium(@Valid @RequestBody Premium premium) throws URISyntaxException {
